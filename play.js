/*  
 *  用于屏蔽页面上的所有flash, copy from https://github.com/nareix/mama-hd
 */
...
function playVideo() {
    window.location.href = "ytb://" + window.location.href;
}
disablePlayer();
playVideo();
